                  ...
                  child: Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(width: 0.7,color: colors[index].withOpacity(opacityColor[index]),),
                      ),
                      child: Padding(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: (){
                                    addressController.deleteAddress(addressController.myAddressData[index]['id']);
                                  },
                                  child: Padding(
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: Text(addressController.myAddressData[index]['nameAddress'],
                                      style: TextStyle(fontSize: 13, color: Colors.grey[700])),
                                ),
                              ],
                            ),
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(
                                  width: screenSize.width * 0.5,
                                  child: Text(addressController.myAddressData[index]['address'],
                                      style: TextStyle(fontSize: 13, color: Colors.grey[700])),
                                ),
                              ],
                            )
